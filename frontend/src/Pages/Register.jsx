...
const onSubmit = async (data) => {
 ...
 if (usernameStatus !== "available") {
  ...
  <div className="w-full max-w-md bg-white my-5 rounded-xl border border-[#E5E7EB] p-8">

    <h1 className="heading text-3xl font-bold text-center text-teal-600">
      Create Account
    </h1>

    <p className="text-center sub-heading text-[#6B7280] mt-2 mb-8">
      ...
      <div>
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute cursor-pointer inset-y-0 right-3 flex items-center text-[#6B7280] hover:text-teal-600"
          >
